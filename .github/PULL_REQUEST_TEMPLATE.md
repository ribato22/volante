...
- [ ] Tests added/updated for the behavior change (see
      [CONTRIBUTING.md](https://github.com/ribato22/baton/blob/main/CONTRIBUTING.md) — test-driven,
...
- [ ] If this touches isolation/sandboxing or the eval scorer: the exact guarantee and its limits
      ...
      [SECURITY.md](https://github.com/ribato22/baton/blob/main/SECURITY.md)) — no overclaiming
